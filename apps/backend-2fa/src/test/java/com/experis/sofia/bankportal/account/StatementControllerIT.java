...
@DisplayName("StatementControllerIT - perimetro de seguridad (DEBT-066)")
class StatementControllerIT extends IntegrationTestBase {

    @Test
    @DisplayName("GET statement sin token -> 401")
    void downloadStatement_noToken_401() throws Exception {
        mockMvc.perform(get("/api/v1/accounts/{a}/statements/{y}/{m}", UUID.randomUUID(), 2026, 1))
